// ===============================================================================
//  <copyright company="Mid-Space Productions" file="GreyscaleEffect.cs">
...
namespace SEToolbox.ImageShaders
{
    ...
    public class GreyscaleEffect : ShaderEffect
    {
        ...
        /// </summary>
        public static readonly DependencyProperty InputProperty = ShaderEffect.RegisterPixelShaderSamplerProperty("Input", typeof(GreyscaleEffect), 0);
